...
down_revision = '3c8d0019257a'
branch_labels = None
depends_on = None


def upgrade() -> None:
    op.execute("CREATE TABLE `shydans_db`.`accounting_supplier` (`id` INT NOT NULL AUTO_INCREMENT , `first_name` VARCHAR(255) NOT NULL , `last_name` VARCHAR(255) NOT NULL , `business_type` VARCHAR(255) NULL , `email` VARCHAR(255) NULL , `contact_number` VARCHAR(255) NULL , `tel_number` VARCHAR(255) NULL , `address` VARCHAR(255) NULL , `tin` VARCHAR(255) NULL , `sec` VARCHAR(255) NULL , `dti` VARCHAR(255) NULL , `created_at` DATETIME on update CURRENT_TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP , PRIMARY KEY (`id`)) ENGINE = InnoDB;")


def downgrade() -> None:
    op.drop_table("accounting_supplier")
